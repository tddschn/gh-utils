...
def test_parse_gh_remote_url():
    assert parse_gh_remote_url("git@github.com:tddschn/gh-utils.git") == ("tddschn", "gh-utils")
    assert parse_gh_remote_url("https://github.com/tddschn/gh-utils.git") == ("tddschn", "gh-utils")
    assert parse_gh_remote_url("git@github.com:tddschn/gh-utils") == ("tddschn", "gh-utils")
    assert parse_gh_remote_url("https://github.com/tddschn/gh-utils") == ("tddschn", "gh-utils")
